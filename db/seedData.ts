...
export const exercisesArray = [
  ...
  { id: 97, name: 'Front Foot Elevated Split Squat', equipmentType: 'barbell' },
  ...
  { id: 107, name: 'Halting Conventional Deadlift', equipmentType: 'barbell' },
  ...
  { id: 157, name: 'Overhead Cable Tricep Extension', equipmentType: 'cable' },
  ...
  { id: 219, name: 'Split Squat (Glute Emphasis)', equipmentType: 'dumbbell' },
  ...
  { id: 239, name: 'Tempo Wide Grip Bench (5:0:0)', equipmentType: 'barbell' },
