  ...
  return (
    ...
    <div className="absolute inset-0 -z-10 overflow-hidden bg-gray-950">
     ...
     {/* custom to handle no logs */}
      ...
      <div className="absolute inset-x-0 right-0 bottom-0 h-px bg-white mix-blend-overlay" />
...
function FixedSidebar({
  ...
  return (
    <div className="flex-none overflow-hidden px-6 lg:pointer-events-none fixed inset-0 z-40 flex">
...
{/* custom to handle no logs */}
      <div className="relative flex w-full lg:pointer-events-auto">
