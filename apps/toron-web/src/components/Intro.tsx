  ...
  return (
    <>
      ...
      <p className='mt-4 text-sm/6 text-gray-300'>
        Toron is a focused, distraction-free workout tracker designed for those
        who train with intent. Log your workouts effortlessly, track muscle
        stimulus over time, and ensure your training aligns with your goals. No
